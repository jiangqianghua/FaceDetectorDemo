 ...
 */
public class DrawFacesView_bk extends View {
    ...
    public DrawFacesView_bk(Context context) {
        this(context, null);
    }

    public DrawFacesView_bk(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public DrawFacesView_bk(Context context, AttributeSet attrs, int defStyle) {
